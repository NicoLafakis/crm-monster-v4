        ...
        return `
            <div class="tool-form">
                ...
                <div class="message warning">
                    ...
                    This will update approximately 2,847 records. This action cannot be undone.
                </div>
                <button class="btn--primary btn--full-width" onclick="window.crmMonster.executeCurrentTool()">
    ...
    getQualityAuditContent() {
        return `
            <div class="tool-form">
                ...
                <div class="message info">
                    <i class="fas fa-info-circle"></i>
                    This audit will analyze approximately 16,523 records and may take a few minutes to complete.
                </div>
                <button class="btn--primary btn--full-width" onclick="window.crmMonster.executeCurrentTool()">
        ...
        return `
            <div class="tool-form">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="6" placeholder='{"properties": {"email": "test@example.com"}}'></textarea>
                </div>
                <button class="btn--primary btn--full-width" onclick="window.crmMonster.executeCurrentTool()">
        ...
        const interval = setInterval(() => {
            ...
            if (progress >= 100) {
                ...
                setTimeout(() => {
                    ...
                    this.showSuccessModal('Import Complete!', `Successfully imported 2,847 contacts. ${this.hubspotData.contacts.toLocaleString()} total contacts in your database.`);
                    this.addActivity('Bulk import completed', '2,847 contacts imported successfully', 'success');
                    this.isProcessing = false;
                }, 500);
            }
        }, 300);
    ...
    simulateMassUpdate() {
        ...
        const interval = setInterval(() => {
            ...
            if (progress >= 100) {
                clearInterval(interval);
                setTimeout(() => {
                    this.showSuccessModal('Update Complete!', 'Successfully updated 2,847 contact records with new property values.');
                    this.addActivity('Mass update completed', '2,847 contacts updated', 'success');
                    this.isProcessing = false;
                }, 500);
            }
        }, 200);
    ...
    simulateQualityAudit() {
        ...
        const interval = setInterval(() => {
            ...
            if (progress >= 100) {
                clearInterval(interval);
                setTimeout(() => {
                    this.showSuccessModal('Audit Complete!', 'Found 234 records with quality issues: 89 missing emails, 67 invalid phone numbers, 78 incomplete addresses.');
                    this.addActivity('Quality audit completed', '234 quality issues identified', 'warning');
                    this.isProcessing = false;
                }, 500);
            }
        }, 350);
        ...
        setTimeout(() => {
            ...
            this.showSuccessModal('API Test Successful!', `
                <div style="text-align: left;">
                    ...
                    <pre style="background: #f5f5f5; padding: 10px; border-radius: 4px; font-size: 12px;">${JSON.stringify(response.data, null, 2)}</pre>
                </div>
            `);
            this.isProcessing = false;
        }, 1500);
